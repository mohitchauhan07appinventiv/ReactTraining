    ...
    return (
      <div className={"headerContainer"}>
        ...
        <div className={"floatingText"}>
          <span className={"specialText"}>{"9 React Developer Tools"}</span>
    ...
    return (
      <div className={"mainContainer"}>
        ...
        <Row
          ...
          info={
            "Official Chrome extesion for React from Facebook that lets you examin the list of components and subcomponents on the webpage"
          }
        />
        <Row
          attr={"nextRow"}
